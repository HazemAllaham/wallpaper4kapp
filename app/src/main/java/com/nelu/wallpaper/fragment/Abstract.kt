...
class Abstract : Fragment() {
    ...
    private var binding: FragmentAbstractBinding? =  null

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?): View? {
        binding = FragmentAbstractBinding.inflate(inflater, container, false)
        ...
        binding?.abstractRecycler?.layoutManager =
            LinearLayoutManager(requireContext())
        binding?.abstractRecycler?.adapter = adapter
